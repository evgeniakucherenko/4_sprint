...
final class MovieQuizViewController: UIViewController {
    ...
    @IBAction private func yesButtonClicked(_ sender: Any) { let currentQuestion = questions[0]
    ...
    @IBAction func noButtonClicked(_ sender: Any) { let currentQuestion = questions[currentQuestionIndex]
